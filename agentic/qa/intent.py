...
Si "navigation" ou "confusion_signal" : pas de champs supplémentaires.

Réponds UNIQUEMENT en JSON strict, sans markdown :
{{"intent": "...", "confidence": 0.0-1.0, "needs_retrieval": true|false, "is_definition": true|false, "definition_term": "...", "feedback_polarity": "positive|negative", "anchored_concept": "...", "needed_rewrite": true|false, "rewritten": "..."}}
"""
...
If "navigation" or "confusion_signal": no extra fields needed.
...
class IntentAgent:
    ...
    def __call__(self, state: TutorState) -> dict[str, Any]:
        ...
        if intent_type == "question":
            ...
            log.info(
                "intent: LLM-classified as %s (conf=%.2f, retrieve=%s)",
                intent.type, intent.confidence, intent.needs_retrieval,
            )
        return result
