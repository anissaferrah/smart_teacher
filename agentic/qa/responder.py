...
def _make_definition_prompt(
    ...
    if lang == "fr":
        return (
            ...
            "RÈGLE STRICTE — TUTEUR LIMITÉ AU COURS : Tu dois UNIQUEMENT utiliser "
            "les informations explicitement présentes dans LA DIAPOSITIVE ACTUELLE "
            "et le CONTEXTE INTERNE fournis ci-dessous. Tu n'es PAS un chatbot "
            "encyclopédique. N'utilise jamais tes connaissances générales, "
            "Wikipedia, ou toute information extérieure. Tu peux utiliser des "
            "analogies ou exemples simples pour aider la compréhension, mais "
            "UNIQUEMENT s'ils sont directement inspirés du matériel de cours. "
            "N'ajoute jamais de faits externes, statistiques ou définitions "
            "absents des chunks.\n"
            "Si la question ne peut pas être répondue à partir du matériel "
            "fourni, réponds avec EXACTEMENT cette phrase et rien d'autre : "
            "\"Ce sujet n'est pas couvert dans le matériel de cours auquel "
            "j'ai accès.\" et laisse \"supporting_chunks\" vide.\n\n"
    ...
    return (
        ...
        "STRICT RULE — COURSE-MATERIAL-BOUND TUTOR: You must ONLY use "
        "information explicitly present in the CURRENT SLIDE and INTERNAL "
        "CONTEXT provided below. You are NOT an encyclopedic chatbot. Never "
        "use general knowledge, Wikipedia, or any outside information. You "
        "may use simple analogies or examples to aid understanding, but "
        "ONLY if they are directly inspired by the course material. Never "
        "add external facts, statistics, or definitions not present in "
        "the chunks.\n"
        "If the question cannot be answered from the provided material, "
        "respond with EXACTLY this sentence and nothing else: \"This topic "
        "is not covered in the course material I have access to.\" and "
        "leave supporting_chunks empty.\n\n"
