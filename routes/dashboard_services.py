...
async def dashboard_services():
    ...
    def _probe_ollama() -> dict:
        ...
        model_name = getattr(fallback, "model", Config.OLLAMA_TEXT_MODEL)
    ...
    try:
        ...
        ollama_status = {
            "available": False,
            "model": getattr(brain.fallback, "model", Config.OLLAMA_TEXT_MODEL) if brain.fallback else Config.OLLAMA_TEXT_MODEL,
